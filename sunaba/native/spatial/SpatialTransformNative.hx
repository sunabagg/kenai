...
extern class SpatialTransformNative extends ComponentNative {
    ...
    public function getParent() : SpatialTransformNative;
    ...
    public static function getFromEntity(entity : EntityNative) : SpatialTransformNative;
}