...
extern class NativeVector2i {
    ...
    public function clamp(min : NativeVector2i, max : NativeVector2i) : Vector2i;
    public function length() : Float;
    public function lengthSquared() : Int;
    public function max(vector2i : NativeVector2i) : Vector2i;
    public function maxAxisIndex() : Int;
    public function min(vector2i : NativeVector2i) : Vector2i;
