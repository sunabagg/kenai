...
extern class Curve3D extends Resource {
    ...
    public function getBakedPoints(): Array<Vector3>;
    public function getBakedTilts(): Array<Float>;
    public function getBakedUpVectors(): Array<Vector3>;
    ...
    public function tessellate(maxStages: Int = 5, toleranceDegrees: Float = 4.0): Array<Vector3>;
    public function tessellateEvenLength(maxStages: Int = 5, toleranceLength: Float = 0.2): Array<Vector3>;
    @:native("cast")
