...
extern class CodeEdit extends TextEdit {
    ...
    public var codeCompletionPrefixes: lua.Table<String>;
    public var delimiterComments: lua.Table<String>;
    public var delimiterStrings: lua.Table<String>;
    ...
    public var indentAutomaticPrefixes: lua.Table<String>;
    public var indentSize: Int;
    public var indentUseSpaces: Bool;
    public var lineFolding: Bool;
    public var lineLengthGuidelines: lua.Table<Int>;
    ...
    public function getBookmarkedLines(): lua.Table<Int>;
    public function getBreakpointedLines(): lua.Table<Int>;
    public function getCodeCompletionOption(index: Int): Dictionary;
    public function getCodeCompletionOptions(): lua.Table<Dictionary>;
    ...
    public function getExecutingLines(): lua.Table<Int>;
    public function getFoldedLines(): lua.Table<Int>;
