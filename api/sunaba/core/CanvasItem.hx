...
extern class CanvasItem extends Element {
    ...
    public function drawColoredPolygon(points: sunaba.core.Vector<Vector2>, color: Color, uvs: sunaba.core.Vector<Vector2> = null, texture: Texture2D = null): Void;
    ...
    public function drawMultiline(points: sunaba.core.Vector<Vector2>, colors: sunaba.core.Vector<Color>, width: Float = -1.0, antialis: Bool = false): Void;
    public function drawMultilineColors(points: sunaba.core.Vector<Vector2>, colors: sunaba.core.Vector<Color>, width: Float = -1.0, antialis: Bool = false): Void;
    public function drawMultilineString(font: Font, pos: Vector2, text: String, alignment: Int = 0, width: Float = -1, fontSize: Int = 16, maxLines: Int = -1, modulate: Color = null, brkFlags: sunaba.core.Vector<Int> = null, justificationFlags: sunaba.core.Vector<Int> = null, direction: Int = 0, orientation: Int = 0): Void;
    public function drawMultilineStringOutline(font: Font, pos: Vector2, text: String, alignment: Int = 0, width: Float = -1, fontSize: Int = 16, maxLines: Int = -1, size: Int = 1, modulate: Color = null, brkFlags: sunaba.core.Vector<Int> = null, justificationFlags: sunaba.core.Vector<Int> = null, direction: Int = 0, orientation: Int = 0): Void;
    public function drawPolygon(points: sunaba.core.Vector<Vector2>, colors: sunaba.core.Vector<Color>, uvs: sunaba.core.Vector<Vector2> = null, texture: Texture2D = null): Void;
    public function darwPolylineColors(points: sunaba.core.Vector<Vector2>, colors: sunaba.core.Vector<Color>, width: Float = -1.0, antialis: Bool = false): Void;
    public function drawPrimitive(points: sunaba.core.Vector<Vector2>, colors: sunaba.core.Vector<Color>, uvs: sunaba.core.Vector<Vector2> = null, texture: Texture2D = null): Void;
    ...
    public function drawString(font: Font, pos: Vector2, text: String, alignment: Int = 0, width: Float = -1, fontSize: Int = 16, modulate: Color = null, justificationFlags: sunaba.core.Vector<Int> = null, direction: Int = 0, orientation: Int = 0): Void;
    public function drawStringOutline(font: Font, pos: Vector2, text: String, alignment: Int = 0, width: Float = -1, fontSize: Int = 16, size: Int = 1, modulate: Color = null, justificationFlags: sunaba.core.Vector<Int> = null, direction: Int = 0, orientation: Int = 0): Void;
