...
extern class Entity extends BaseObject {
    ...
    public function getComponentsByType(type : Class<Component>) : lua.Vector<Component>;

    public function getUserComponentsByType(type : Class<Behavior>) : lua.Vector<Behavior>;
