...
extern class FontFile extends Font {
    ...
    public function getGlyphList(cacheIndex : Int, size : Vector2i) : sunaba.core.Vector<Int>;
    ...
    public function getKerningList(cacheIndex : Int, size : Vector2i) : sunaba.core.Vector<Vector2i>;
    public function getLanguageSupportOverride(lang : String) : Bool;
    public function getScriptSupportOverride(script : String) : Bool;
    public function getScriptSupportOverrides() : sunaba.core.Vector<String>;
    public function getSizeCacheList(cacheIndex: Int): sunaba.core.Vector<Vector2i>;
    ...
    public function setTextureOffsets(cacheIndex : Int, size : Vector2i, textureIndex : Int, offsets : sunaba.core.Vector<Vector2i>) : Void;
