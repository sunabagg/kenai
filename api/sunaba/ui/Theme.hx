...
extern class Theme extends Resource {
    ...
    public function getColorList(type: String): sunaba.core.Vector<String>;
    public function getColorTypeList(type: String): sunaba.core.Vector<String>;
    public function getConstant(name: String, type: String): Float;
    public function getConstantList(type: String): sunaba.core.Vector<String>;
    public function getConstantTypeList(type: String): sunaba.core.Vector<String>;
    public function getFont(name: String, type: String): Font;
    public function getFontList(type: String): sunaba.core.Vector<String>;
    public function getFontTypeList(type: String): sunaba.core.Vector<String>;
    public function getFontSize(name: String, type: String): Float;
    public function getFontSizeList(type: String): sunaba.core.Vector<String>;
    public function getFontSizeTypeList(type: String): sunaba.core.Vector<String>;
    public function getIcon(name: String, type: String): Texture2D;
    public function getIconList(type: String): sunaba.core.Vector<String>;
    public function getIconTypeList(type: String): sunaba.core.Vector<String>;
    public function getStyleBox(name: String, type: String): StyleBox;
    public function getStyleBoxList(type: String): sunaba.core.Vector<String>;
    public function getStyleBoxTypeList(type: String): sunaba.core.Vector<String>;
    public function getThemeItem(name: String, type: String): Resource;
    public function getThemeItemList(type: String): sunaba.core.Vector<String>;
    public function getThemeItemTypeList(type: String): sunaba.core.Vector<String>;
    public function getTypeList(): sunaba.core.Vector<String>;
    public function getTypeVariationBase(themeType: String): String;
    public function getTypeVariationList(themeType: String): sunaba.core.Vector<String>;
