...
extern class Entity extends BaseObject {
    ...
    public function getComponentsByType(type : Class<Component>) : kenai.core.Vector<Component>;

    public function getUserComponentsByType(type : Class<Behavior>) : kenai.core.Vector<Behavior>;
