...
extern class CanvasItem extends Element {
    ...
    public function drawColoredPolygon(points: kenai.core.Vector<Vector2>, color: Color, uvs: kenai.core.Vector<Vector2> = null, texture: Texture2D = null): Void;
    ...
    public function drawMultiline(points: kenai.core.Vector<Vector2>, colors: kenai.core.Vector<Color>, width: Float = -1.0, antialis: Bool = false): Void;
    public function drawMultilineColors(points: kenai.core.Vector<Vector2>, colors: kenai.core.Vector<Color>, width: Float = -1.0, antialis: Bool = false): Void;
    public function drawMultilineString(font: Font, pos: Vector2, text: String, alignment: Int = 0, width: Float = -1, fontSize: Int = 16, maxLines: Int = -1, modulate: Color = null, brkFlags: kenai.core.Vector<Int> = null, justificationFlags: kenai.core.Vector<Int> = null, direction: Int = 0, orientation: Int = 0): Void;
    public function drawMultilineStringOutline(font: Font, pos: Vector2, text: String, alignment: Int = 0, width: Float = -1, fontSize: Int = 16, maxLines: Int = -1, size: Int = 1, modulate: Color = null, brkFlags: kenai.core.Vector<Int> = null, justificationFlags: kenai.core.Vector<Int> = null, direction: Int = 0, orientation: Int = 0): Void;
    public function drawPolygon(points: kenai.core.Vector<Vector2>, colors: kenai.core.Vector<Color>, uvs: kenai.core.Vector<Vector2> = null, texture: Texture2D = null): Void;
    public function darwPolylineColors(points: kenai.core.Vector<Vector2>, colors: kenai.core.Vector<Color>, width: Float = -1.0, antialis: Bool = false): Void;
    public function drawPrimitive(points: kenai.core.Vector<Vector2>, colors: kenai.core.Vector<Color>, uvs: kenai.core.Vector<Vector2> = null, texture: Texture2D = null): Void;
    ...
    public function drawString(font: Font, pos: Vector2, text: String, alignment: Int = 0, width: Float = -1, fontSize: Int = 16, modulate: Color = null, justificationFlags: kenai.core.Vector<Int> = null, direction: Int = 0, orientation: Int = 0): Void;
    public function drawStringOutline(font: Font, pos: Vector2, text: String, alignment: Int = 0, width: Float = -1, fontSize: Int = 16, size: Int = 1, modulate: Color = null, justificationFlags: kenai.core.Vector<Int> = null, direction: Int = 0, orientation: Int = 0): Void;
