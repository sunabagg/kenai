...
extern class RichTextLabel extends Control {
    ...
    public var finished: kenai.core.Event;
    public var metaClicked: kenai.core.Event;
    public var metaHoverEnded: kenai.core.Event;
    public var metaHoverStarted: kenai.core.Event;
    public function addImage(image: kenai.core.Texture2D, ?width: Int, ?height: Int, ?color: Color, ?inlineAlign: Int, ?region: Rect2, ?key: Variant, ?pad: Bool, ?tooltip: String, ?sizeInPercent: Bool ): Void;
    ...
    public function updateImage(key: Variant, mask: Int, image: kenai.core.Texture2D, ?width: Int, ?height: Int, ?color: Color, ?inlineAlign: Int, ?region: Rect2, ?pad: Bool, ?tooltip: String, ?sizeInPercent: Bool): Void;
    @:native("cast")
    public static function toRichTextLabel(obj: Dynamic): kenai.ui.RichTextLabel;
}

abstract RichTextLabelAbstract(RichTextLabel) from RichTextLabel to RichTextLabel {
    @:from
    public static function fromElement(element: kenai.core.Element): kenai.ui.RichTextLabel {
        var richTextLabel = kenai.ui.RichTextLabel.toRichTextLabel(element);
