...
extern class MenuBar extends Control {
    ...
    @:native("cast")
    public static function toMenuBar(obj: Dynamic): kenai.ui.MenuBar;
}

abstract MenuBarAbstract(MenuBar) from MenuBar to MenuBar {
    @:from
    public static function fromElement(element: kenai.core.Element): kenai.ui.MenuBar {
        var menuBar = kenai.ui.MenuBar.toMenuBar(element);
        if (menuBar.isNull()) {
            return null;
        }
        return menuBar;
