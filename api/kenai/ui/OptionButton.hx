...
extern class OptionButton extends Button {
    ...
    public var itemFocused: kenai.core.Event;
    public var itemSelected: kenai.core.Event;
    ...
    @:native("cast")
    public static function toOptionButton(obj: Dynamic): kenai.ui.OptionButton;
}

abstract OptionButtonAbstract(OptionButton) from OptionButton to OptionButton {
    @:from
    public static function fromElement(element: kenai.core.Element): kenai.ui.OptionButton {
        var optionButton = kenai.ui.OptionButton.toOptionButton(element);
