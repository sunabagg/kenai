        ...
        for (attribute in attributes) {
            ...
            if (attributeName == "name") {
                ...
                if (hasField(element, attributeName)) {
                    ...
                    else if (StringTools.contains(getUsertypeName(currentValue), "sol.kenai::core::Texture2D")) {
                    ...
                    else if (StringTools.contains(getUsertypeName(currentValue), "sol.kenai::core::Texture")) {
                        var image = Image.loadFromFile(io, attributeValue);
                        if (image != null) {
                            var texture = ImageTexture.createFromImage(image);
                            if (texture != null && !texture.isNull()) {
