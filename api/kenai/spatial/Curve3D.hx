...
extern class Curve3D extends Resource {
    ...
    public function getBakedPoints(): kenai.core.Vector<Vector3>;
    public function getBakedTilts(): kenai.core.Vector<Float>;
    public function getBakedUpVectors(): kenai.core.Vector<Vector3>;
    ...
    public function tessellate(maxStages: Int = 5, toleranceDegrees: Float = 4.0): kenai.core.Vector<Vector3>;
    public function tessellateEvenLength(maxStages: Int = 5, toleranceLength: Float = 0.2): kenai.core.Vector<Vector3>;
    @:native("cast")
