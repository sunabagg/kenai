...
namespace sunaba::spatial
{
    ...
    class IGeometryInstance : public IVisualInstance
    {
        ...
        Dictionary getData() override {
            ...
            dict["visibilityRangeFadeMode"] = getVisibilityRangeFadeMode();
        ...
        void setData(Dictionary dict) override {
            ...
            setVisibilityRangeEndMargin(dict["visibilityRangeEndMargin"]);
            setVisibilityRangeFadeMode(dict["visibilityRangeFadeMode"]);
        }
    };
}
