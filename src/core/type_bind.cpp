...
void sunaba::core::bind_base_types(sol::state& lua) {
    ...
    lua.new_usertype<Array>("Array",
        ...
        "append", &Array::append,
        "append_array", &Array::append_array,
        "assign", &Array::assign,
        "back", &Array::back,
        "bsearch", &Array::bsearch,
        "bsearch_custom", &Array::bsearch_custom,
        "clear", &Array::clear,
        "count", &Array::count,
        ...
        "is_read_only", &Array::is_read_only,
        "make_read_only", &Array::make_read_only,
        "max", &Array::max,
        "min", &Array::min,
        "pick_random", &Array::pick_random,
        "pop_at", &Array::pop_at,
        "pop_back", &Array::pop_back,
        "pop_front", &Array::pop_front,
        "push_back", &Array::push_back,
        "push_front", &Array::push_front,
        "remove_at", &Array::remove_at,
        "resize", &Array::resize,
        "reverse", &Array::reverse,
        "rfind", &Array::rfind,
        "rfind_custom", &Array::rfind_custom,
        "set", &Array::set,
