...
namespace kenai::core {
    ...
    class ViewportProxy : public ViewportNode {
        ...
        public:
            kenai::core::Viewport* element = nullptr;
    ...
    class Viewport : public Element {
        ...
        public:
            ...
            kenai::spatial::World3D* getWorld3D() {
                return new kenai::spatial::World3D(viewport->get_world_3d().ptr());
            }

            void setWorld3D(kenai::spatial::World3D* world) {
            ...
            kenai::spatial::World3D* findWorld3D() {
                return new kenai::spatial::World3D(viewport->find_world_3d().ptr());
            }
            ...
            kenai::ui::Control* guiGetFocusOwner() {
                return new kenai::ui::Control(viewport->gui_get_focus_owner());
            }

            kenai::ui::Control* guiGetHoveredControl() {
                return new kenai::ui::Control(viewport->gui_get_hovered_control());
            }
            ...
            void pushInput(kenai::input::InputEvent* event, bool inLocalCoords = false) {
            ...
            void pushUnhandledInput(kenai::input::InputEvent* event, bool inLocalCoords = false) {
