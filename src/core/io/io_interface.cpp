...
void kenai::core::io::bindIoInterface(sol::state& lua) {
...
std::string kenai::core::io::IoInterface::getLuaRequirePath(const std::string &path) const {
...
std::string kenai::core::io::IoInterface::getFilePathFromLuaRequirePath(const std::string &path) const {
