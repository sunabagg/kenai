...
void lucidware::core::io::bindIoInterface(sol::state& lua) {
...
std::string lucidware::core::io::IoInterface::getLuaRequirePath(const std::string &path) const {
...
std::string lucidware::core::io::IoInterface::getFilePathFromLuaRequirePath(const std::string &path) const {
