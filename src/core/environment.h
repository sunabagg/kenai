...
namespace kenai::core {
    ...
    public:
        ...
        kenai::core::Texture* getAdjustmentColorCorrection() {
            return new kenai::core::Texture(environment->get_adjustment_color_correction().ptr());
        }

        void setAdjustmentColorCorrection(kenai::core::Texture* texture) {
        ...
        kenai::spatial::Sky* getSky() {
            return new kenai::spatial::Sky(environment->get_sky().ptr());
        }

        void setSky(kenai::spatial::Sky* sky) {
