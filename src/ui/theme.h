...
namespace kenai::ui {
    ...
    class Theme : public kenai::core::Resource {
    private:
        GodotTheme* theme;
    public:
        Theme() {
        ...
        kenai::core::Font* getDefaultFont() {
            return new kenai::core::Font(theme->get_default_font().ptr());
        }

        void setDefaultFont(kenai::core::Font* font) {
        ...
        kenai::core::Font* getFont(const std::string& name, const std::string& type) {
            return new kenai::core::Font(theme->get_font(name.c_str(), type.c_str()).ptr());
        }
        ...
        kenai::core::Texture2D* getIcon(const std::string& name, const std::string& type) {
            return new kenai::core::Texture2D(theme->get_icon(name.c_str(), type.c_str()).ptr());
        }
        ...
        kenai::ui::StyleBox* getStyleBox(const std::string& name, const std::string& type) {
            return new kenai::ui::StyleBox(theme->get_stylebox(name.c_str(), type.c_str()).ptr());
        }
        ...
        sol::stack_object getThemeItem(lua_State* L, int dataType, const std::string& name, const std::string& type) {
            return kenai::core::to_lua(L, theme->get_theme_item(static_cast<GodotTheme::DataType>(dataType), name.c_str(), type.c_str()));
        }
        ...
        void setFont(const std::string& name, const std::string& type, kenai::core::Font* font) {
        ...
        void setIcon(const std::string& name, const std::string& type, kenai::core::Texture2D* icon) {
            theme->set_icon(name.c_str(), type.c_str(), godot::Ref<GodotTexture2D>(icon->getTexture()));
        }

        void setStyleBox(const std::string& name, const std::string& type, kenai::ui::StyleBox* styleBox) {
