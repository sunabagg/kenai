...
namespace kenai::ui {
    ...
    class TextureRectProxy : public TextureRectNode {
        ...
        public:
            kenai::ui::TextureRect* element = nullptr;
    ...
    class TextureRect : public kenai::ui::Control {
        private:
        ...
        public:
            ...
            kenai::core::Texture2D* getTexture() {
                return new kenai::core::Texture2D(texture_rect->get_texture().ptr());
            }

            void setTexture(kenai::core::Texture2D* texture) {
