...
namespace kenai::ui {
    ...
    class LabelProxy : public LabelNode {
        ...
        public:
            kenai::ui::Label* element = nullptr;
    ...
    class Label : public Control {
        ...
        public:
            ...
            kenai::core::LabelSettings* getLabelSettings() {
                Ref<godot::LabelSettings> settings = label_node->get_label_settings();
                return new kenai::core::LabelSettings(settings.ptr());
            }

            void setLabelSettings(kenai::core::LabelSettings* settings) {
