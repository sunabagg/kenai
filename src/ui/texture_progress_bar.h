...
namespace lucidware::ui {
    ...
    class TextureProgressBarProxy : public TextureProgressBarNode {
        ...
        public:
            lucidware::ui::TextureProgressBar* element = nullptr;
    ...
    class TextureProgressBar : public Range {
        ...
        public:
            ...
            lucidware::core::Texture2D* getTextureOver() {
                return new lucidware::core::Texture2D(proxy->get_over_texture().ptr());
            }

            void setTextureOver(lucidware::core::Texture2D* texture) {
                proxy->set_over_texture(texture->getTexture2D());
            }

            lucidware::core::Texture2D* getTextureProgress() {
                return new lucidware::core::Texture2D(proxy->get_progress_texture().ptr());
            }

            void setTextureProgress(lucidware::core::Texture2D* texture) {
            ...
            lucidware::core::Texture2D* getTextureUnder() {
                return new lucidware::core::Texture2D(proxy->get_under_texture().ptr());
            }

            void setTextureUnder(lucidware::core::Texture2D* texture) {
