...
namespace kenai::ui {
    ...
    class MenuBarProxy : public MenuBarNode {
        ...
        public:
            kenai::ui::MenuBar* element = nullptr;
    ...
    class MenuBar : public kenai::ui::Control {
        private:
        ...
        kenai::desktop::PopupMenu* getMenuPopup(int32_t p_menu) {
            return new kenai::desktop::PopupMenu(menuBar->get_menu_popup(p_menu));
        }
