...
namespace kenai::ui {
    ...
    class TreeItem : public BaseObject {
        ...
        public:
            ...
            void addButton(int column, kenai::core::Texture2D* button, int id = -1, bool disabled = false, std::string toolTipText = "") {
            ...
            kenai::core::Texture2D* getButton(int column, int idx) const {
                return new kenai::core::Texture2D(tree_item->get_button(column, idx).ptr());
            }
            ...
            kenai::core::Font* getCustomFont(int column) const {
                return new kenai::core::Font(tree_item->get_custom_font(column).ptr());
            }
            ...
            kenai::core::Texture2D* getIcon(int column) const {
                return new kenai::core::Texture2D(tree_item->get_icon(column).ptr());
            }
            ...
            kenai::core::Texture2D* getIconOverlay(int column) const {
                return new kenai::core::Texture2D(tree_item->get_icon_overlay(column).ptr());
            }
            ...
            void setButton(int column, int buttonIdx, kenai::core::Texture2D* button) {
            ...
            void setCustomFont(int column, kenai::core::Font* font) {
            ...
            void setIcon(int column, kenai::core::Texture2D* texture) {
            ...
            void setIconOverlay(int column, kenai::core::Texture2D* texture) {
            ...
            void setTextAlignment(int column, int alignment) {
                tree_item->set_text_alignment(column, static_cast<HorizontalAlignment>(alignment));
            }
