...
namespace kenai::ui {
    ...
    class ButtonProxy : public ButtonNode {
        ...
        public:
            kenai::ui::Button* element = nullptr;
    ...
    class Button : public kenai::ui::BaseButton {
        private:
        ...
        public:
            ...
            kenai::core::Texture2D* getIcon() {
                return new kenai::core::Texture2D(button->get_button_icon().ptr());
            }

            void setIcon(kenai::core::Texture2D* texture) {
