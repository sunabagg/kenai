...
namespace kenai::ui {
    ...
    class ItemListProxy : public ItemListNode {
        ...
        public:
            kenai::ui::ItemList* element = nullptr;
        ...
        public:
            ...
            int addIconItem(kenai::core::Texture2D* texture, bool selectable = true) {
            ...
            int addItem(std::string text, kenai::core::Texture2D* icon = nullptr, bool selectable = true) {
            ...
            kenai::core::Texture2D* getItemIcon(int index) {
                Ref<godot::Texture2D> textureRef = item_list->get_item_icon(index);
                return new kenai::core::Texture2D(textureRef.ptr());
            }
