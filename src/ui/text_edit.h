...
namespace kenai::ui {
    ...
    class TextEditProxy : public TextEditNode {
        ...
        public:
            kenai::ui::TextEdit* element = nullptr;
    ...
    class TextEdit : public Control {
        ...
        public:
            ...
            kenai::core::Texture2D* getLineGutterIcon(int line, int gutter) {
                return new kenai::core::Texture2D(text_edit->get_line_gutter_icon(line, gutter).ptr());
            }
            ...
            kenai::desktop::PopupMenu* getMenu() {
                return new kenai::desktop::PopupMenu(text_edit->get_menu());
            }
            ...
            void setLineGutterIcon(int line, int gutter, kenai::core::Texture2D* icon) {
