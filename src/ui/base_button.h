...
namespace kenai::ui {
    ...
    class BaseButtonProxy : public BaseButtonNode {
        ...
        public:
            kenai::ui::BaseButton* element = nullptr;
    ...
    class BaseButton : public kenai::ui::Control {
        private:
        ...
        public:
            ...
            kenai::input::Shortcut* getShortcut() {
                return new kenai::input::Shortcut(base_button->get_shortcut().ptr());
            }

            void setShortcut(kenai::input::Shortcut* shortcut) {
