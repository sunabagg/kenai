...
namespace sunaba::ui {
    ...
    class RichTextLabel : public Control {
        ...
        public:
            ...
            void addImage(sunaba::core::Texture2D* image, int width = 0, int height = 0, Color color = Color(1, 1, 1, 1), int inlineAlign = 5, Rect2 region = Rect2(0, 0, 0, 0), Variant key = Variant(), bool pad = false, std::string tooltip = "''", bool sizeInPercent = false) {
