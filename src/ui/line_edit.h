...
namespace lucidware::ui {
    ...
    class LineEditProxy : public LineEditNode {
        ...
        public:
            lucidware::ui::LineEdit* element = nullptr;
    ...
    class LineEdit : public Control {
        ...
        public:
            ...
            lucidware::core::Texture2D* getRightIcon() {
                return new lucidware::core::Texture2D(line_edit_node->get_right_icon().ptr());
            }

            void setRightIcon(lucidware::core::Texture2D* icon) {
            ...
            lucidware::desktop::PopupMenu* getMenu() {
                return new lucidware::desktop::PopupMenu(line_edit_node->get_menu());
            }
