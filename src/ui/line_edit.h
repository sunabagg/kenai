...
namespace kenai::ui {
    ...
    class LineEditProxy : public LineEditNode {
        ...
        public:
            kenai::ui::LineEdit* element = nullptr;
    ...
    class LineEdit : public Control {
        ...
        public:
            ...
            kenai::core::Texture2D* getRightIcon() {
                return new kenai::core::Texture2D(line_edit_node->get_right_icon().ptr());
            }

            void setRightIcon(kenai::core::Texture2D* icon) {
            ...
            kenai::desktop::PopupMenu* getMenu() {
                return new kenai::desktop::PopupMenu(line_edit_node->get_menu());
            }
