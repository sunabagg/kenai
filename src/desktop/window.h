...
namespace kenai::desktop {
    ...
    class WindowProxy : public WindowNode {
        ...
        public:
            kenai::desktop::Window* element = nullptr;
    ...
    class Window : public kenai::core::Viewport {
        private:
        ...
        public:
            ...
            void setWindow(WindowNode* window) {
                this->window = window;
                this->window->set_theme(Ref<godot::Theme>(kenai::ui::uiGlobals::getGlobalTheme()->getTheme()));
            ...
            kenai::ui::Theme* getTheme() {
                return new kenai::ui::Theme(window->get_theme().ptr());
            }

            void setTheme(kenai::ui::Theme* theme) {
            ...
            void addThemeIconOverride(std::string name, kenai::core::Texture2D* icon) {
            ...
            kenai::core::Font* getThemeDefaultFont() {
                return new kenai::core::Font(window->get_theme_default_font().ptr());
            }
            ...
            kenai::core::Font* getThemeFont(std::string name, std::string type = "&") {
                return new kenai::core::Font(window->get_theme_font(name.c_str(), type.c_str()).ptr());
            }
            ...
            kenai::core::Texture2D* getThemeIcon(std::string name, std::string type = "&") {
                return new kenai::core::Texture2D(window->get_theme_icon(name.c_str(), type.c_str()).ptr());
            }

            kenai::ui::StyleBox* getThemeStyleBox(std::string name, std::string type = "&") {
                return new kenai::ui::StyleBox(window->get_theme_stylebox(name.c_str(), type.c_str()).ptr());
            }
