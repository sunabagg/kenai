...
int main() {
    ...
    // Register luasocket modules for Lua 5.1 compatibility
    ...
    lua_pop(L, 2); // Remove package.preload and package from stack
    
    // Test basic functionality
    const char* test_code = 
        "local socket_core = require('socket.core')\n"
        "local mime_core = require('mime.core')\n"
        "print('LuaSocket core module loaded successfully!')\n"
    ...
    lua_close(L);
    printf("LuaSocket static library test completed successfully!\n");
    return 0;
}
